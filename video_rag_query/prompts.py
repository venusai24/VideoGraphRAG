...
traverse step:
  {"step": <n>, "operation": "traverse", "from": "<EntityRef|ClipRef|var>", "edge": "<APPEARS_IN|NEXT|SHARES_ENTITY|RELATED_TO>", "to": "<EntityRef|ClipRef|var>", "filter": {<optional>}}
...
3. sub_queries: ordered decomposition. Each must include id, type, goal, required_graph_components.
